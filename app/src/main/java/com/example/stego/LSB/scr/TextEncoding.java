 ...
 */
public class TextEncoding extends AsyncTask<Steganography, Integer, Steganography> {
    ...
    private final EncCallback callbackInterface;
    private int maximumProgress;
    private final ProgressDialog progressDialog;

    public TextEncoding(Activity activity, EncCallback callbackInterface) {
        super();
    ...
    @Override
    protected void onPostExecute(Steganography textStegnography) {
    ...
    protected Steganography doInBackground(Steganography... imageSteganographies) {
        ...
        if (imageSteganographies.length > 0) {
            ...
            Steganography textStegnography = imageSteganographies[0];
