...
import com.example.stego.LSB.Util.Crypto;
...
public class Steganography {
    ...
    public Steganography(String message, String secret_key, Bitmap image) {
    ...
    public Steganography(String secret_key, Bitmap image) {
        this.secret_key = convertKeyTo128bit(secret_key);
        this.image = image;
